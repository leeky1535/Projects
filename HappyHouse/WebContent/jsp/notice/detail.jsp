	...
	<div
		...
		<div class="row">
			...
			<input type="hidden" name="act" value="list">
            	<%--<input type="hidden" name="no" value="${ann.no }"> --%>

				<div class="mb-3">
					<label for="title" class="form-label">제목</label> <input type="text"
						class="form-control" id="title" name="title" value="${ann.no }. ${ann.title }" disabled="disabled" style="color: black;">
				</div>
				<div class="mb-3">
					<label for="content" class="form-label">내용</label>
					<textarea class="form-control" id="content" name="content" rows="9" disabled="disabled" style="color: black;">${ann.content }</textarea>
				</div>
				<div class="row sinfo text-center">
                    <button type="button" id="listBtn" class="btn btn-outline-primary">목록으로 돌아가기</button>
                </div>
			</div>
			</form>
		</div>
